  ...
  return (
    <div className="bg-gray-50 pt-20">
      <div className="mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        <div className="relative w-full aspect-[4/3] sm:aspect-[21/9] rounded-2xl sm:rounded-3xl overflow-hidden bg-gray-900">
          <Image 
            src="/assets/hero.jpg" 
          ...
          <div className="absolute inset-0 max-w-[1600px] mx-auto">
            <div className="h-full flex flex-col justify-center px-6 sm:px-12">
              <div className="max-w-3xl">
                <div className="text-xs sm:text-sm font-medium text-green-400 tracking-wide mb-4">
                  PROFESSIONAL TREE CARE SERVICES
                </div>
                <h1 className="text-2xl sm:text-3xl md:text-5xl lg:text-[4.5rem] font-normal text-white mb-4 sm:mb-6 leading-[1.1] tracking-[-0.02em]">
                  A better way to care for your trees
                </h1>
                <p className="text-sm sm:text-base md:text-lg text-gray-300 mb-6 sm:mb-8 leading-relaxed max-w-2xl">
                ...
                >
                  <span className="text-sm sm:text-base md:text-lg">Request a Quote</span>
                  <svg 
